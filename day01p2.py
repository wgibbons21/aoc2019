...
filehandle = open('/Users/wgibbons/Documents/Advent of Code/2019/input/day01')
...
# number of values to calculate fuel for in the file
mass_values = contents.__len__()

for i in range(0, mass_values):
    mass = contents[i].rstrip('\n')
    mass = int(mass)
    #have to subtract mass since recursive function adds it in during first call
    total_fuel += calc_fuel(mass) - mass
    print("Mass = ", mass ,"\tFuel Required = ", calc_fuel(mass) - mass)
